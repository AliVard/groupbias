...
from ltr.allrank.config import PositionalEncoding
from ltr.allrank.positional import _make_positional_encoding
...
def make_transformer(N=6, d_ff=2048, h=8, dropout=0.1, n_features=136,
    ...
    positional_encoding = type('PositionalEncoding', (object,), dict(positional_encoding))
